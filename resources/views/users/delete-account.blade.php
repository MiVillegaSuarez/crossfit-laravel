...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <header>
        <nav class="container-fluid"> 
                <div class="row">
                <div class="col-12 delete-sec-01-logo">
                    <a href="/">
    ...
    <section class="container delete-seccion-01">
        <div class="row">
            <div class="col-sm-12 col-lg-12">
                <div class="delete-sec-01-title">
                    <h2>DELETE ACCOUNT</h2>
                </div>
                <div class="delete-sec-01-text">
                    <p>If you are sure about deleting your account connected to CrossFit, enter your Email and click the button.</p>
                </div>
                <form method="POST" action="/delete-account-validation" class="delete-sec-01-form">
                    <div class="mb-3">
                        <label class="form-label">Email</label>
                        <input type="email" name="email" class="form-control" aria-describedby="emailHelp">
                    </div>
                    <div class="d-grid gap-2 delete-sec-01-btn">
                        <button type="submit" class="btn btn-primary btn-lg">DELETE ACCOUNT NOW</button>
                    </div>
                </form>
                <div class="delete-sec-01-login">
                    <span>I no longer want to delete my account </span><a href="/">Log In</a>
                </div>
            </div>
        </div>
    </section>
