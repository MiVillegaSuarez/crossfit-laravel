...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <header>
        <nav class="container-fluid"> 
                <div class="row">
                <div class="col-12 newpass-sec-01-logo">
                    <a href="/">
    ...
    <section class="container newpass-seccion-01">
        <div class="row">
            <div class="col-sm-12 col-lg-12">
                <div class="newpass-sec-01-title">
                    <h2>CREATE NEW PASSWORD</h2>
                </div>
                <div class="newpass-sec-01-text">
                    <p>Enter a new password to associate with your CrossFit account.</p>
                </div>
                <form method="POST" action="/new-password-validation" class="newpass-sec-01-form">
                    <div class="mb-3">
                        <label class="form-label">New Password</label>
                        <input type="password" name="new-password" class="form-control" aria-describedby="emailHelp">
                    </div>
                    <div class="mb-3">
                        {{-- <input type="hidden" name="email" class="form-control" aria-describedby="emailHelp" value="<?= $_SESSION["email_new_password"] ?>"> --}}
                        <input type="hidden" name="email" class="form-control" aria-describedby="emailHelp" value="123">
                    </div>
                    <div class="d-grid gap-2 newpass-sec-01-btn">
                        <button type="submit" class="btn btn-primary btn-lg">CREATE PASSWORD</button>
                    </div>
                </form>
                <div class="newpass-sec-01-login">
                    <span>Have you already remembered your password? </span><a href="/">Log In</a>
                </div>
            </div>
        </div>
    </section>
