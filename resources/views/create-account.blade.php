...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <header>
        <nav class="container-fluid"> 
                <div class="row">
                <div class="col-12 create-sec-01-logo">
                    <a href="/">
    ...
    <!-- Inicio Seccion 01 - Formulario para logearse -->
    <section class="container create-seccion-01">
        <div class="row">
                ...
                <form method="POST" action="/create-account-validation" class="create-sec-01-form">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            {{-- <?php
                                echo '<select name="day" class="form-select" aria-label="Default select example">';
                                ...
                                echo '<select name="month" class="form-select" aria-label="Default select example">';
                                echo '<option selected>Month</option>';
                                for($i = 0; $i < count($months); $i++) {
                                    echo '<option value="' . strtolower($months[$i]) . '">' . $months[$i] . '</option>';
                                }
                                echo '</select>';
                            
                                echo '<select name="year" class="form-select" aria-label="Default select example">';
                    ...
                    <div class="mb-3 form-check create-sec-01-check">
                        <input type="checkbox" class="form-check-input" id="validationCustom03" required>
                        <label class="form-check-label" for="validationCustom03">I have read and agree to CrossFit’s <span>Terms & Conditions</span></label>
                    ...
                    <div class="mb-3 form-check create-sec-01-check">
                        ...
                        <label class="form-check-label" for="exampleCheck1">I have read and agree to CrossFit’s <span>Privacy Policy</span></label>
                        <div class="invalid-feedback">
                            You should accept the privacy policy
                        </div>
                    </div>
                    <div class="d-grid gap-2 create-sec-01-btn">
                        <button type="submit" class="btn btn-primary btn-lg">CREATE ACCOUNT</button>
                    </div>
                </form>
                <div class="create-sec-01-login">
