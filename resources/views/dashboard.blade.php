...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <!-- Titulo -->
        <title>Dashboard Crossfit</title>
    ...
    <body style="background-color: #f2f2f2;">
        ...
        <section class="container home-seccion-02">
            ...
            <div class="row row-cols-1 row-cols-md-3 g-5 home-sec-02-card">
                <div class="col">
                    <div class="card">
                        <img src="{{asset('images/43j2t0a6rqnrc0cucc0m.jpg')}}" class="card-img-top" alt="...">
                        <div class="card-body">
                ...
                <div class="col">
                    <div class="card">
                        <img src="{{asset('images/izft0n7n2hs2fi09hxrr.jpg')}}" class="card-img-top" alt="...">
                        <div class="card-body">
                ...
                <div class="col">
                    <div class="card">
                        <img src="{{asset('images/vdgb0xm11py34yt7m1l5.jpg')}}" class="card-img-top" alt="...">
                        <div class="card-body">
        ...
        <section class="container home-seccion-04">
            ...
            <div class="row row-cols-1 row-cols-md-3 g-5 home-sec-04-card">
                <div class="col">
                    <div class="card">
                        <img src="{{asset('images/056hh5vv14yrmr48ue75.jpg')}}" class="card-img-top" alt="...">
                        <div class="card-body">
                ...
                <div class="col">
                    <div class="card">
                        <img src="{{asset('images/n7uf9sokpo96rv9fo9k2.jpg')}}" class="card-img-top" alt="...">
                        <div class="card-body">
                ...
                <div class="col">
                    <div class="card">
                        <img src="{{asset('images/gxrhsk5774y5sizq593u.jpg')}}" class="card-img-top" alt="...">
                        <div class="card-body">
